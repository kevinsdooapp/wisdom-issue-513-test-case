 ...
 */
public class PlatformAdmin2IT extends WisdomBlackBoxTest {

    @Test
    /**
     * see https://github.com/wisdom-framework/wisdom/issues/513
     */
    public void testThatTheAdministrationPageIsServedWithAbsoluteTemplatePathResolution() throws Exception {
        HttpResponse<Document> page = get("/platform/admin2").asHtml();
